...
#: A2 DIBAYAR (2026-08-25) — SATU PEMILIK PENAGIHAN BERULANG: modul INI.
#: Dulu satu PO custom yang menggantung menghasilkan DUA pesan setiap hari dari dua
#: mesin berbeda — `special_order_approval` (job keadaan, `dedupe_scope="day"`) dan
#: `approval_backlog` (pengingat ini) — yang menyebut dokumen yang SAMA. Kotak yang
#: isinya berulang adalah kotak yang berhenti dibaca.
#: Pembagian tugasnya sekarang tegas:
#:   · `notification_service.notify_special_order_waiting` → MELAHIRKAN pesan SEKALI
#:     (`dedupe_scope="ever"`) untuk dokumen yang belum pernah punya penerima;
#:   · modul ini → satu-satunya yang MENAGIH BERULANG (harian, `dedupe_scope="day"`).
#: Isi ringkasan di sini SENGAJA tetap LENGKAP (tidak menyaring dokumen yang sudah
#: pernah diberitahukan): begitu ia menyembunyikan dokumen tertua, judulnya akan
#: berbunyi "tertua 6 hari" padahal kenyataannya 9 — angka beranda vs pengingat
#: berselisih, kelas cacat yang justru diperangi INV-HOME-01.
