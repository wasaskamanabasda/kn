...
async def delete_purchase_return(return_id: str) -> Dict[str, Any]:
    ...
    # INV-REF-04 — retur draf sudah menaut PO/GRN-nya sejak lahir (`reverses`).
    # Tanpa sapuan ini, PO yang MASIH HIDUP memegang ref `reversed_by` ke retur
    # yang sudah tidak ada — jejak menunjuk hantu.
    await _refs.safe_unlink_all("purchase_return", return_id)
