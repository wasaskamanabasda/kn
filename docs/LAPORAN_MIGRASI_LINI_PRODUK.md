...
| `PFP-KTN-001` | Kain PFP Katun (siap print, per Yard) | printing | sudah terisi — tidak diubah | tidak |
...
|---|---|---|
| `sales_orders` | 0 | 11 |
| `purchase_orders` | 0 | 17 |
| `purchase_requisitions` | 0 | 8 |
